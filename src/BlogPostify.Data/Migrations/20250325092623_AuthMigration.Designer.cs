...
namespace BlogPostify.Data.Migrations
{
    ...
    [Migration("20250325092623_AuthMigration")]
            ...
            modelBuilder.Entity("BlogPostify.Domain.Entities.Post", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Content", "BlogPostify.Domain.Entities.Post.Content#MultyLanguageField", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Title", "BlogPostify.Domain.Entities.Post.Title#MultyLanguageField", b1 =>
                        {
                            b1.IsRequired();
